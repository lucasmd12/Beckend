...
ClanMissionSchema.index({ clanId: 1 });
ClanMissionSchema.index({ createdBy: 1 });
ClanMissionSchema.index({ type: 1 });
ClanMissionSchema.index({ status: 1 });
ClanMissionSchema.index({ expiresAt: 1 });
ClanMissionSchema.index({ createdAt: -1 });

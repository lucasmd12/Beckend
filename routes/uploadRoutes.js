 ...
 */
// ✅✅✅ CORREÇÃO APLICADA ✅✅✅
// A rota agora usa o middleware 'auth' e a documentação Swagger aponta para a URL correta.
router.post("/profile-picture", auth, uploadController.uploadProfilePicture);


/**
 * @swagger
 * /api/uploads/clan-flag/{clanId}:
 *   post:
...
/**
 * @swagger
 * /api/uploads/federation-tag/{federationId}:
 *   put:
...
/**
 * @swagger
 * /api/uploads/user-identity/{userId}:
 *   get:

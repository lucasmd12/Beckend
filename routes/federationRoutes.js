 ...
 *         description: Erro no servidor
 */
router.put("//:id/add-enemy/:enemyId", protect, authorizeFederationLeaderOrADM, federationController.addEnemy);
 ...
 *         description: Erro no servidor
 */
router.put("//:id/remove-enemy/:enemyId", protect, authorizeFederationLeaderOrADM, federationController.removeEnemy);
 ...
 *         _id:
 *           type: string
 *           description: ID único da federação
 *         name:
 *           type: string
 *           description: Nome da federação
 *         description:
 ...
 *         leader:
 *           type: string
 *           description: ID do líder da federação
 *         subLeaders:
 *           type: array
 *           items:
 *             type: string
 *           description: IDs dos sub-líderes da federação
 *         clans:
 *           type: array
 *           items:
 *             type: string
 *           description: IDs dos clãs que fazem parte da federação
 *         allies:
 *           type: array
 *           items:
 *             type: string
 *           description: IDs das federações aliadas
 *         enemies:
 *           type: array
 *           items:
 *             type: string
 *           description: IDs das federações inimigas
 *         banner:
 *           type: string
 *           description: URL do banner da federação
 *           nullable: true
 *         createdAt:
 *           type: string
 *           format: date-time
 *           description: Data de criação da federação
 *         updatedAt:
 *           type: string
 *           format: date-time
 *           description: Data da última atualização da federação
 *       example:
 *         _id: "60d5ec49f8c7b7001c8e4d1a"
 *         name: "Federação Alfa"
 *         description: "A maior federação do servidor."
 *         leader: "60d5ec49f8c7b7001c8e4d1b"
 *         subLeaders: ["60d5ec49f8c7b7001c8e4d1c"]
 *         clans: ["60d5ec49f8c7b7001c8e4d1d", "60d5ec49f8c7b7001c8e4d1e"]
 *         allies: ["60d5ec49f8c7b7001c8e4d1f"]
 *         enemies: ["60d5ec49f8c7b7001c8e4d20"]
 *         banner: "https://example.com/banner_alfa.png"
